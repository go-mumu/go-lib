...
type Messenger struct {
	...
	// Stdin is the location where input is read. Leave for extension.
	Stdin io.Reader
...
// MsgFunc msg.Func signature of output function
type MsgFunc func(msg string, args ...interface{})
